...
def main():
    ...
    flag = 0
    while len(q) > 0:
        r, b, cnt, dir, path = q[0][0], q[0][1], q[0][2], q[0][3], q[0][4] #ball이 사라지면 none을오 표시
